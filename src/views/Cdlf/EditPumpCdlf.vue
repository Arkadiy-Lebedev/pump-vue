...
const loadPumpOne = async (id: string[] | string) => {
  fetch(`${API}api/pump-cdlf/read_one.php?id=${id}`)
    ...
    .then((data) => {
      ...
      pump.b12 = JSON.parse(data.b12)
      pump.d1 = JSON.parse(data.d1)
      pump.d2 = JSON.parse(data.d2)
...
const updatePump = async () => {
  ...
  axios.post(`${API}api/pump-cdlf/update.php`, formData)
    .then(response => {
    ...
    <Fieldset legend="График кривой" class="mt-5">
      ...
      <div class="sm:flex gap-5  mt-10 ">
        <div class="input-group">
          ...
          <InputNumber v-model="pump.start" :minFractionDigits="4" inputId="withoutgrouping"
            :class="{ 'p-invalid': errorMessage }" />
        </div>
        <div class="input-group">
          <label class="input-group__label">Конечная точка *</label>
          <InputNumber v-model="pump.finish" :minFractionDigits="4" inputId="withoutgrouping"
            :class="{ 'p-invalid': errorMessage }" />
        </div>
        <div class="input-group">
          <label class="input-group__label">Шаг кривой</label>
          <InputNumber v-model="pump.step" :minFractionDigits="4" inputId="withoutgrouping" />
        </div>
      </div>
      ...
      <div class="sm:flex gap-5  mt-5">
        <div class="input-group">
          ...
          <InputNumber v-model="pump.minx" :minFractionDigits="2" inputId="withoutgrouping" />
        </div>
        <div class="input-group">
          <label class="input-group__label">Шкала Q (м³/ч) (X), максимум</label>
          <InputNumber v-model="pump.maxx" :minFractionDigits="2" inputId="withoutgrouping" />
        </div>
        <div class="input-group">
          <label class="input-group__label">Шаг шкалы Q (м³/ч) (X)</label>
          <InputNumber v-model="pump.step_x" :minFractionDigits="2" inputId="withoutgrouping" />
        </div>
      </div>
